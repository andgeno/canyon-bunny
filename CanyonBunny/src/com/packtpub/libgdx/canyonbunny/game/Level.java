...
public class Level {
	...
	private void init (String filename) {
		...
		// book
		helpTilt = new Help();
		helpTilt.setAnimation(Assets.instance.book.animHelpTilt);
		helpTilt.position.y = 10000;
		helpTouch = new Help();
		helpTouch.setAnimation(Assets.instance.book.animHelpTouch);
		helpTouch.position.y = 10000;
		helpFly = new Help();
		helpFly.setAnimation(Assets.instance.book.animHelpFly);
		helpFly.position.y = 10000;
