...
public class Assets implements Disposable, AssetErrorListener {
	...
	public class AssetBook {
		public final AtlasRegion cover;
		...
		public AssetBook (TextureAtlas atlas) {
			cover = atlas.findRegion("book-cover");

			Array<AtlasRegion> regions = null;
			AtlasRegion region = null;

			// Animation: Help Idle
			animHelpIdle = new Animation(1.0f / 1.0f, atlas.findRegions("help/normal"));

			// Animation: Help Tilt
			regions = atlas.findRegions("help/anim_tilt");
			regions.insert(2, regions.get(0));
			animHelpTilt = new Animation(1.0f / 2.0f, regions, Animation.LOOP);

			// Animation: Help Tilt
			regions = atlas.findRegions("help/anim_touch");
			animHelpTouch = new Animation(1.0f / 5.0f, regions, Animation.LOOP_PINGPONG);

			// Animation: Help Fly
			regions = atlas.findRegions("help/anim_fly");
			animHelpFly = new Animation(1.0f / 20.0f, regions, Animation.LOOP_PINGPONG);
		}
	}
